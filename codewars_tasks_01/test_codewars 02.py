...
# alp  # '''
# Боб работает водителем автобуса. Однако он стал чрезвычайно
# популярен среди жителей города. С таким количеством пассажиров,
# желающих попасть на борт его автобуса, ему иногда приходится
# сталкиваться с проблемой нехватки места в автобусе! Он хочет,
# чтобы вы написали простую программу, сообщающую ему, сможет ли он вместить всех пассажиров.
#
# Обзор задач:
...
# Если места достаточно, верните 0, а если нет,
# верните количество пассажиров, которых он не может взять.
# '''
#
# cap = 100
# on = 60
